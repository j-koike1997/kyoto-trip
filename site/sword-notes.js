(()=>{
  const notes={
    ...
    'history-2':{level:'直結',title:'伏見は「刀槍 vs 砲・小銃」がぶつかった場所',text:'鳥せい本店の周辺は、鳥羽・伏見の戦いの激戦地に近いにゃ。新選組や会津藩を中心とする旧幕府軍は伏見奉行所に陣を置き、土方歳三の指揮下で刀や槍を手に応戦した一方、新政府軍は高所から大砲を撃ち込んだにゃ。ここは「剣術の強さ」だけでは戦争に勝てない近代戦への転換を、街そのものから感じられる場所にゃ。',source:'https://www.city.kyoto.lg.jp/fushimi/page/0000014952.html',sourceLabel:'京都市伏見区役所'},
